# Baseline Language Roadmap

**Aspirational Features — v0.2 and Beyond**

> These features are part of Baseline's roadmap but are not yet implemented. They are extracted from the language specification to keep the core spec focused on what exists today. Designs here are subject to change.
...
12. [Specification Verification](#12-specification-verification)
13. [Neurosymbolic Feedback Loop](#13-neurosymbolic-feedback-loop)
14. [Extended Compiler API](#14-extended-compiler-api)
15. [Constrained Generation Protocol](#15-constrained-generation-protocol)
16. [LLM Bootstrap Kit](#16-llm-bootstrap-kit)
17. [Trace Format](#17-trace-format)
...
## 12. Specification Verification

*Moved from spec §8.4–8.5, §8.7 — these sections describe verification infrastructure that depends on unimplemented SMT-based spec checking.*

### 12.1 SMT-Based Specification Verification
...
### 12.3 Verified Control / Generated Data Separation
...
The control flow is formally verified. The data transformation is type-checked and tested. Typed holes (§4.9 in the spec) make this explicit: verified control flow is concrete code, data transformations start as holes.

---

## 13. Neurosymbolic Feedback Loop

*Moved from spec §8.6 — aspirational architecture for LLM+verification integration.*
...
2. **Generation**: Agent generates code (optionally with constrained generation — §15).
...
## 14. Extended Compiler API

*Moved from spec §10.3–10.6, §1.5.5 — planned JSON APIs for LLM and IDE integration.*

### 14.1 Extended Query API
...
### 14.2 Programmatic Compilation API
...
### 14.3 Interactive Refinement Session
...
### 14.4 Interactive Refinement Protocol
...
### 14.5 Bulk Operations for LLM Agents
...
## 15. Constrained Generation Protocol

*Moved from spec §11 — full protocol specification for type-constrained LLM token generation.*
...
### 15.5 Integration with Existing Infrastructure
...
## 16. LLM Bootstrap Kit

*Moved from spec §12 — training corpus strategy and few-shot examples for LLM code generation.*
...
### 16.1 `llms.txt` Specification File
...
### 16.2 Canonical Few-Shot Examples
...
### 16.4 Model Compatibility Testing
...
*Moved from spec Appendix B — binary trace format for runtime debugging.*
